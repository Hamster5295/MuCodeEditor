...
object HtmlToken {
    val CSS_CODE_BLOCK_START = ThemeToken(ThemeToken.KEYWORD_COLOR, "CSS_CODE_BLOCK_START")
    val CSS_CODE_BLOCK_END = ThemeToken(ThemeToken.KEYWORD_COLOR, "CSS_CODE_BLOCK_END")

    val ECMASCRIPT_CODE_BLOCK_START = ThemeToken(ThemeToken.KEYWORD_COLOR, "ECMASCRIPT_CODE_BLOCK_START")
    val ECMASCRIPT_CODE_BLOCK_END = ThemeToken(ThemeToken.KEYWORD_COLOR, "ECMASCRIPT_CODE_BLOCK_END")

    val IDENTIFIER = ThemeToken(ThemeToken.IDENTIFIER_COLOR_TOKEN, "IDENTIFIER")
    val ATTRIBUTE = ThemeToken(ThemeToken.NUMERICAL_VALUE_COLOR, "ATTRIBUTE")
    val ELEMENT_NAME = ThemeToken(ThemeToken.KEYWORD_COLOR, "ELEMENT_NAME")
    val WHITESPACE = ThemeToken(ThemeToken.KEYWORD_COLOR, "WHITESPACE")
    val DOCTYPE = ThemeToken(ThemeToken.NUMERICAL_VALUE_COLOR, "DOCTYPE")

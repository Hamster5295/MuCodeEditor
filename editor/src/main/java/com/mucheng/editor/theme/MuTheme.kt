...
//修改后, MuTheme成为BaseTheme的子类
//其实有点多余了，可以考虑把BaseTheme并入AbstractTheme
@Suppress("SpellCheckingInspection")
open class MuTheme(styleManager: EditorStyleManager) : BaseTheme(styleManager, name = "default", data = ThemeData()) {
}
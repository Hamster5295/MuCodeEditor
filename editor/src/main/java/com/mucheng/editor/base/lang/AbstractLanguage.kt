...
abstract class AbstractLanguage {
    ...
    abstract fun getUserDefinedAutoCompletionItems(): List<AutoCompletionItem>

    abstract fun addUserDefinedAutoCompletionItem(autoCompletionItem: AutoCompletionItem)

    abstract fun addUserDefinedAutoCompletionItems(autoCompletionItems: List<AutoCompletionItem>)

    abstract fun clearUserDefinedAutoCompletionItems()
